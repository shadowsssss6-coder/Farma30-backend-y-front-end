...
/**
 * Controlador de Autenticación (RF01, RF14, RF15). Corresponde al
 * componente Usuario, que expone la interfaz IAutenticacion.
 */
class AuthController extends Controller
{
    ...
    public function recuperarClave(Request $request)
    {
        ...
        // Aquí se integraría Laravel Notifications para enviar el correo real.
